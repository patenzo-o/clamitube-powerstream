...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an educational content creator. Generate high-quality educational content based on the user's prompt. 
...
Format your response as structured educational content.`;
